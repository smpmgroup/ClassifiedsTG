      ...
      <div className="steps">
        ...
        <article>
          ...
          <div>
            ...
            <p>
              Укажите название проекта или сообщества. Здесь будут финансовая
              история, обращения и одна или несколько досок.
            </p>
          </div>
        </article>
        <article>
    ...
    <main className="web-login">
      ...
      <section>
        ...
        <aside>
          ...
          <span>
            {platformOwner
              ? "Организации → сообщества → Stars → TON → выплаты → аудит"
              : "Организация → группа → права бота → правила и цена → запуск"}
          </span>
        </aside>
      </section>
    </main>
